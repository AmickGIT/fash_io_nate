...
class CPDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        densepose_end_of_torso_mask = torch.FloatTensor((densepose_map_wo_normalize[1:2,:,:].cpu().numpy() == (80/ 255.)).astype(np.int64)) # a channel of torso region has 80 value in a painter app.
